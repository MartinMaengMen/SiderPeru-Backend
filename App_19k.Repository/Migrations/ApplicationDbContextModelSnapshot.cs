            ...
            modelBuilder.Entity("App_19k.Domain.Administrador", b =>
                {
                    ...
                    b.Property<int?>("AdministradorNavigationUsuarioId");

                    b.Property<bool?>("FAdminGeneral");

                    b.HasKey("AdministradorId");

                    b.HasIndex("AdministradorNavigationUsuarioId");
            ...
            modelBuilder.Entity("App_19k.Domain.Vendedor", b =>
                {
                    ...
                    b.Property<int?>("VendedorNavigationUsuarioId");

                    b.HasKey("VendedorId");

                    b.HasIndex("VendedorNavigationUsuarioId");
            ...
            modelBuilder.Entity("App_19k.Domain.Administrador", b =>
                {
                    b.HasOne("App_19k.Domain.Usuario", "AdministradorNavigation")
                        .WithMany()
                        .HasForeignKey("AdministradorNavigationUsuarioId");
                });
